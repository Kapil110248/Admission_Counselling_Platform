...
# Find line 968 (0-indexed: 967) where settings starts
# We insert the scholarship tab section BEFORE "{activeTab === 'settings' &&"
target_line = None
...
if target_line is None:
    print("ERROR: Could not find settings tab line")
    exit(1)

print(f"Found settings at line {target_line + 1}")
...
lines.insert(target_line, scholarship_section)

with open(filepath, "w", encoding="utf-8") as f:
    f.writelines(lines)

print(f"SUCCESS: Scholarship section inserted before line {target_line + 1}")
